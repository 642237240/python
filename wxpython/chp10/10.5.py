...
class MyFrame(wx.Frame):
    ...
    def OnToggleItem(self, event):
        ...
        #enabled = menubar.FindItemById(ID_SIMPLE).IsEnabled()
        #menubar.FindItemById(ID_SIMPLE).Enable(not enabled)
        enabled = menubar.FindItemById(ID_SIMPLE).GetMenu().IsEnabled(ID_SIMPLE)
        menubar.FindItemById(ID_SIMPLE).GetMenu().Enable(ID_SIMPLE, not enabled)
